...
#define MASK_HALIUM (M(ROM_HALIUM_INTERNAL))
...
#define HALIUM_DATA_IMG_MINSIZE 1024
#define HALIUM_DATA_IMG_DEFSIZE 4095
...
public:
	...
	static bool haliumProcessBoot(const std::string& root);
	static bool haliumProcess(const std::string& root, const std::string& name);
